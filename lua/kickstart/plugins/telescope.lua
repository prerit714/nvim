...
return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    -- By default, Telescope is included and acts as your picker for
    -- everything.

    -- If you would like to switch to a different picker (like snacks, or
    -- fzf-lua) you can disable the Telescope plugin by setting enabled to
    -- false and enable your replacement picker by requiring it explicitly
    -- (e.g. 'custom.plugins.snacks')

    -- Note: If you customize your config for yourself, it’s best to remove the
    -- Telescope plugin config entirely instead of just disabling it here, to
    ...
    config = function()
      ...
      -- there). This allows easily switching between pickers if you prefer
      ...
      -- `:help telescope.builtin.live_grep()` for information about particular
      -- keys
      vim.keymap.set(
        "n",
        "<leader>s/",
