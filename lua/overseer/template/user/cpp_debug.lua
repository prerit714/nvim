...
local cpp_competitive_flags = "-std=c++23 -fsanitize=address,undefined -g3 -O0 -Wall -Weffc++ -Wextra -Wshadow -Wconversion -Wsign-conversion -Werror -pedantic-errors -DLOCAL"
